...
(function($) {
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            button: function(options) { return 'Выбор'; },
            feedback: function(options) { return 'загрузка файлов'; },
            feedback2: function(options) { return 'Выбранно ' + options.length + (options.length > 1 ? ' фаилов' : ' фаил ') + ''; },
